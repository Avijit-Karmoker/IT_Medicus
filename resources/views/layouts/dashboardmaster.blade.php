...
<head>
	...
	<link rel="stylesheet" href="{{ asset('dashboard_assets') }}/assets/vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('dashboard_assets') }}/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="{{ asset('dashboard_assets') }}/assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('dashboard_assets') }}/assets/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('dashboard_assets') }}/assets/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('dashboard_assets') }}/assets/images/logo-text.png" alt="">
            </a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ asset('dashboard_assets') }}/assets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="{{ asset('dashboard_assets') }}/assets/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('dashboard_assets') }}/assets/images/profile/17.jpg" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ asset('dashboard_assets') }}/assets/app-profile.html" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="{{ route('company.index') }}" aria-expanded="false">
                            <i class="fa fa-building"></i>
							<span class="nav-text">Compaines</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="{{ route('company.index') }}">All Compaines</a></li>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('dashboard_assets') }}/assets/vendor/global/global.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/assets/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('dashboard_assets') }}/assets/js/custom.min.js"></script>
	<script src="{{ asset('dashboard_assets') }}/assets/js/deznav-init.js"></script>
	<script src="{{ asset('dashboard_assets') }}/assets/vendor/owl-carousel/owl.carousel.js"></script>

	<!-- Chart piety plugin files -->
    <script src="{{ asset('dashboard_assets') }}/assets/vendor/peity/jquery.peity.min.js"></script>

	<!-- Apex Chart -->
	<script src="{{ asset('dashboard_assets') }}/assets/vendor/apexchart/apexchart.js"></script>

	<!-- Dashboard 1 -->
	<script src="{{ asset('dashboard_assets') }}/assets/js/dashboard/dashboard-1.js"></script>
	<script>
